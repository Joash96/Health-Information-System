...
<head>
	...
	<title>CEMA | Account Login</title>
...
<body class="geex-dashboard authentication-page">
			...
			<div class="geex-content__authentication__content">
				<div class="geex-content__authentication__content__wrapper">
					<div class="geex-content__authentication__content__logo">
						<a href="index.html">
							<img class="logo-lite" style="width:300px;" src="{{ asset('public/assets/img/cemapng3.png') }}" alt="logo">
							<img class="logo-dark" style="width:300px;" src="{{ asset('public/assets/img/cemapng3.png') }}" alt="logo">
						</a>
					</div>
					<form id="signInForm" method="POST" action="{{ route('doctor.login.submit') }}" class="geex-content__authentication__form">
					@csrf
    ...
    <span>Password: <code>password</code></span>
			...
			<div class="geex-content__authentication__img">
				<img src="{{ asset('public/assets/img/loginbg2.png') }}" alt="">
			</div>
		</div>
	</main>

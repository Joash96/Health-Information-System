                        ...
                        <form action="{{ route('doctors.update', $doctor) }}" method="POST">
                            ...
                            <div class="geex-content__form__single__box mb-20">
                                <div class="input-wrapper">
                                    ...
                                    <input value="{{ $doctor->name }}" name="name" class="form-control" id="geex-input5" required />
                                </div>
                            </div>
                            ...
                            <div class="geex-content__form__single__box mb-20">
                                <div class="input-wrapper">
                                    ...
                                    <input value="{{ $doctor->email }}" name="email" class="form-control" id="geex-input5" required />
                                </div>
                            </div>

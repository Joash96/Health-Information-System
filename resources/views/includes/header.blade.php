			...
			<ul class="geex-header__menu">
				...
				<li class="geex-header__menu__item has-children">
					...
					<ul class="geex-header__submenu">
						<li class="geex-header__menu__item">
							<a href="{{ route('programs.index') }}" class="geex-header__menu__link ">All Programs</a>
						</li>
						<li class="geex-header__menu__item">
							<a href="{{ route('programs.create') }}" class="geex-header__menu__link ">New Program</a>
						</li>
				...
				<li class="geex-header__menu__item has-children">
					...
					<ul class="geex-header__submenu">
						<li class="geex-header__menu__item">
							<a href="{{ route('clients.index') }}" class="geex-header__menu__link">All Clients</a>
						</li>
						<li class="geex-header__menu__item">
							<a href="{{ route('clients.create') }}" class="geex-header__menu__link">New Client</a>
						</li>
				...
				<li class="geex-header__menu__item has-children">
					...
					<ul class="geex-header__submenu">
						<li class="geex-header__menu__item">
							<a href="{{ route('doctors.index') }}" class="geex-header__menu__link">All Doctors</a>
						</li>
						<li class="geex-header__menu__item">
							<a href="{{ route('doctors.create') }}" class="geex-header__menu__link">New Doctor</a>
						</li>
				...
				<li class="geex-header__menu__item has-children">
					...
					<ul class="geex-header__submenu">
						<li class="geex-header__menu__item">
							<a href="{{ route('profile.edit') }}" class="geex-header__menu__link">Profile</a>
						</li>
						<li class="geex-header__menu__item">

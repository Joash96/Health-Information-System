...
<div class="geex-sidebar">
	...
	<img class="logo-lite" src="{{ asset('public/assets/img/cemapng3.png') }}" alt="logo" style="max-width: 100%; height: auto; width: 300px;" />
	<img class="logo-dark" src="{{ asset('public/assets/img/cemapng3.png') }}" alt="logo" style="max-width: 100%; height: auto; width: 300px;" />
</a>
			...
			<ul class="geex-sidebar__menu">
				...
				<li class="geex-sidebar__menu__item has-children">
					...
					<ul class="geex-sidebar__submenu">
						<li class="geex-sidebar__menu__item">
							<a href="{{ route('programs.index') }}" class="geex-sidebar__menu__link ">All Programs</a>
						</li>
						<li class="geex-sidebar__menu__item">
							<a href="{{ route('programs.create') }}" class="geex-sidebar__menu__link ">New Program</a>
						</li>
				...
				<li class="geex-sidebar__menu__item has-children">
					...
					<ul class="geex-sidebar__submenu">
						...
						<li class="geex-sidebar__menu__item">
							<a href="{{ route('enrollments.index') }}" class="geex-sidebar__menu__link ">Enrollments</a>
						</li>
						<li class="geex-header__menu__item">
							<a href="{{ route('enrollments.create') }}" class="geex-header__menu__link ">New Enrollment</a>
						</li>
				...
				<li class="geex-sidebar__menu__item has-children">
					...
					<ul class="geex-sidebar__submenu">
						<li class="geex-sidebar__menu__item">
							<a href="{{ route('clients.index') }}" class="geex-sidebar__menu__link">All Clients</a>
						</li>
						<li class="geex-sidebar__menu__item">
							<a href="{{ route('clients.create') }}" class="geex-sidebar__menu__link">New Client</a>
						</li>
				...
				<li class="geex-sidebar__menu__item has-children">
					...
					<ul class="geex-sidebar__submenu">
						<li class="geex-sidebar__menu__item">
							<a href="{{ route('doctors.index') }}" class="geex-sidebar__menu__link">All Doctors</a>
						</li>
						<li class="geex-sidebar__menu__item">
							<a href="{{ route('doctors.create') }}" class="geex-sidebar__menu__link">New Doctor</a>
						</li>
				...
				<li class="geex-sidebar__menu__item has-children">
					...
					<ul class="geex-sidebar__submenu">
						<li class="geex-sidebar__menu__item">
							<a href="{{ route('profile.edit') }}" class="geex-sidebar__menu__link">Profile</a>
						</li>
						<li class="geex-sidebar__menu__item">
							<a href="/generate-api-key" class="geex-sidebar__menu__link">API Details</a>
						</li>
        ...
        <div class="geex-sidebar__footer" style="text-align:center;">
			<span class="geex-sidebar__footer__title" style="text-align:center;">CEMA</span>

...
<div class="swiper-slide">
    <div class="geex-content__feature__card">
        ...
        <div class="geex-content__feature__card__text">
            <span class="geex-content__feature__card__price">{{ $clientCount }}</span>
            <a href="{{ route('clients.index') }}"><span class="geex-content__feature__card__growth success-color">See More</span></a>
        </div>
    </div>
</div>
...
<div class="swiper-slide">
    <div class="geex-content__feature__card">
        ...
        <div class="geex-content__feature__card__text">
            <span class="geex-content__feature__card__price">{{ $programCount }}</span>
            <a href="{{ route('programs.index') }}"><span class="geex-content__feature__card__growth danger-color">See More</span></a>
        </div>
    </div>
</div>
...
<div class="swiper-slide">
    <div class="geex-content__feature__card">
        ...
        <div class="geex-content__feature__card__text">
            <span class="geex-content__feature__card__price">{{ $doctorCount }}</span>
            <a href="{{ route('doctors.index') }}"><span class="geex-content__feature__card__growth success-color">See More</span></a>
        </div>
    </div>
</div>
    ...
    <div class="geex-content__widget__single geex-content__widget__news">
        ...
        <a href="{{ route('clients.create') }}" class="geex-btn">
            Add New Client

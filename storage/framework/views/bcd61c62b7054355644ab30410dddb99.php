		...
		<div class="geex-content">
			<div class="geex-content__header">
				<div class="geex-content__header__content">
					<h2 class="geex-content__header__title">CEMA | New Doctor</h2>
                        ...
                        <form action="<?php echo e(route('doctors.store')); ?>" method="POST">
                            ...
                            <div class="geex-content__form__single__box mb-20">
                                <div class="input-wrapper">
                                    <label for="geex-input5" class="input-label">Doctor's Name</label>
                                    <input placeholder="Fullname" name="name" class="form-control" id="geex-input5" required />
                                </div>
                            </div>

                            <div class="geex-content__form__single__box mb-20">
                                <div class="input-wrapper">
                                    <label for="geex-input5" class="input-label">Doctor's Email</label>
                                    <input placeholder="Email Address" name="email" class="form-control" id="geex-input5" required />
                                </div>
                            </div>
                            ...
                            <div class="geex-content__form__single__box mb-20">
                                <div class="input-wrapper">
                                    <label for="geex-input5" class="input-label">Login Password</label>
                                    <input type="password" placeholder="Secure Password" name="password" class="form-control" id="geex-input5" required />
                                </div>
                            </div>
            
                            
            
                            <button type="submit" class="btn btn-success w-100">Add New Doctor</button>
                        </form>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH /home1/pulselin/public_html/hospital/resources/views/doctors/create.blade.php ENDPATH**/ ?>
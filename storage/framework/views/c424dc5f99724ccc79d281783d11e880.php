...
<head>
  ...
  <title>Todo - Geex Dashboard</title>
					...
					<div class="geex-content__section geex-content__section--transparent geex-content__todo">
						<div class="geex-content__todo__sidebar">
							<div class="geex-content__todo__sidebar__label">
								<form method="POST" action="<?php echo e(route('generate.api.key')); ?>">
									<?php echo csrf_field(); ?>
...
</html><?php /**PATH /home1/pulselin/public_html/hospital/resources/views/api-key.blade.php ENDPATH**/ ?>
		...
		<div class="geex-content">
			<div class="geex-content__header">
				<div class="geex-content__header__content">
					<h2 class="geex-content__header__title">CEMA | Edit Doctor</h2>
                        ...
                        <form action="<?php echo e(route('doctors.update', $doctor)); ?>" method="POST">
                            ...
                            <div class="geex-content__form__single__box mb-20">
                                <div class="input-wrapper">
                                    ...
                                    <input value="<?php echo e($doctor->name); ?>" name="name" class="form-control" id="geex-input5" required />
                                </div>
                            </div>
                            ...
                            <div class="geex-content__form__single__box mb-20">
                                <div class="input-wrapper">
                                    ...
                                    <input value="<?php echo e($doctor->email); ?>" name="email" class="form-control" id="geex-input5" required />
                                </div>
                            </div>
...
</html><?php /**PATH /home1/pulselin/public_html/hospital/resources/views/doctors/edit.blade.php ENDPATH**/ ?>
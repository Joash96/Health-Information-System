			...
			<ul class="geex-sidebar__menu">
				...
				<li class="geex-sidebar__menu__item has-children">
					...
					<ul class="geex-sidebar__submenu">
						<li class="geex-sidebar__menu__item">
							<a href="<?php echo e(route('programs.index')); ?>" class="geex-sidebar__menu__link ">All Programs</a>
						</li>
						<li class="geex-sidebar__menu__item">
							<a href="<?php echo e(route('programs.create')); ?>" class="geex-sidebar__menu__link ">New Program</a>
						</li>
				...
				<li class="geex-sidebar__menu__item has-children">
					...
					<ul class="geex-sidebar__submenu">
						<li class="geex-sidebar__menu__item">
							<a href="<?php echo e(route('clients.index')); ?>" class="geex-sidebar__menu__link">All Clients</a>
						</li>
						<li class="geex-sidebar__menu__item">
							<a href="<?php echo e(route('clients.create')); ?>" class="geex-sidebar__menu__link">New Client</a>
						</li>
				...
				<li class="geex-sidebar__menu__item has-children">
					...
					<ul class="geex-sidebar__submenu">
						<li class="geex-sidebar__menu__item">
							<a href="<?php echo e(route('doctors.index')); ?>" class="geex-sidebar__menu__link">All Doctors</a>
						</li>
						<li class="geex-sidebar__menu__item">
							<a href="<?php echo e(route('doctors.create')); ?>" class="geex-sidebar__menu__link">New Doctor</a>
						</li>
				...
				<li class="geex-sidebar__menu__item has-children">
					...
					<ul class="geex-sidebar__submenu">
						<li class="geex-sidebar__menu__item">
							<a href="<?php echo e(route('profile.edit')); ?>" class="geex-sidebar__menu__link">Profile</a>
						</li>
						<li class="geex-sidebar__menu__item">
...
</div><?php /**PATH /home1/pulselin/public_html/hospital/resources/views/includes/sidebar.blade.php ENDPATH**/ ?>
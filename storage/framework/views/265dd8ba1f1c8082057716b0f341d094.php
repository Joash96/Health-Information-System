													...
													<div class="top-area">
														...
														<div class="action-area">
															...
															<div class="geex-content__chat__header__filter__content">
																<a class="dropdown-item" href="<?php echo e(route('programs.show', $program->id)); ?>">view</a>
																
															</div>
														</div>
													</div>
													<div class="details-area">
														<h4 class="name"><?php echo e($program->name); ?></h4>
														<span class="designation">CEMA Program</span>
														<div class="contact-wrapper">
															<a href="#" class="single-contact">
                                                                <i class="uil uil-notes"></i>
                                                                <p>About: <?php echo e(Str::limit($program->description, 100)); ?></p>
                                                            </a>
                                                            <a href="#" class="single-contact">
                                                                <i class="uil uil-user-md"></i>
                                                                <p><small class="text-muted">Created by Dr. <?php echo e($program->doctor->name); ?></small></p>
                                                            </a>
...
</html><?php /**PATH /home1/pulselin/public_html/hospital/resources/views/programs/index.blade.php ENDPATH**/ ?>